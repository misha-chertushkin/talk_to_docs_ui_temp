...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    talk2DocsAuthUserSubject.add(
      Talk2DocsAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<Talk2DocsAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  Talk2DocsAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = Talk2DocsAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    talk2DocsAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
